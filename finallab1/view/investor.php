...
<body>
	...
	<font face="daggersquare" color="#02a95c">Fund Lagbe!</font></h1>
	        ...
	        <p align="right">
			 ...
			 <form action= "../New%20folder/investorController.php" method ="post" enctype="multipart/form-data">
			<fieldset>
				<legend align="center"> Invest </legend>
					...
					<td>ID</td>
						...
						<td>
							...
							<option value="">Please Select a Individual/Organization</option>
								<option value="Molla's Book House">Molla's Book House(10% interest)</option>
								<option value="Fab Fashion Kingdom">Fab Fashion Kingdom(10% interest)</option>
                                <option value="Shaiaz Internet Service">Shaiaz Internet Service(10% interest)</option>
                                <option value="Alif Bakary">Alif Bakary(10% interest) </option>
